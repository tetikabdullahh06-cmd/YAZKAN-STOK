...
const TURNING_CATALOG = [
  ...
  { label: "MGEHR 2525-3 — kanal", name: "MGEHR 2525-3 Kanal Kateri", type: "CNC Torna / Kanal Açma", length: "150", diameter: "25x25" },
  { label: "MGEHR 3232-4 — kanal", name: "MGEHR 3232-4 Kanal Kateri", type: "CNC Torna / Kanal Açma / 32x32", length: "170", diameter: "32x32" },
  { label: "MGEHR 2020-2 — kesme", name: "MGEHR 2020-2 Kesme Kateri", type: "CNC Torna / Kesme", length: "125", diameter: "20x20" },
