      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-slate-900/80 backdrop-blur-xl border border-slate-800 rounded-2xl p-8 shadow-2xl">
          ...
          <form onSubmit={onSubmit} className="space-y-5">
            <div>
              <label className="block text-xs font-semibold text-slate-400 mb-2 uppercase tracking-wider">Ad Soyad</label>
            ...
            <div>
              <label className="block text-xs font-semibold text-slate-400 mb-2 uppercase tracking-wider">Şifre (en az 6 karakter)</label>
            ...
            {err && <div data-testid="register-error" className="text-sm bg-red-500/10 border border-red-500/30 text-red-400 rounded-lg p-3">{err}</div>}
          ...
          <div className="mt-6 pt-6 border-t border-slate-800 text-center text-sm text-slate-400">
            ...
            <Link to="/giris" className="text-blue-400 hover:text-blue-300 font-semibold">Giriş Yap</Link>
          </div>
        </div>
      </div>
    </div>
